...
python3 ../include/param_rf_gen.py
python3 ../include/instr_converter.py

xrun -work WORK -access +r ../test/testbench.v -l ./my_work_dir/xrun.log -xmlibdirpath ./my_work_dir +define+RTL_VERIFY > ./my_work_dir/run.log
